      ...
      <div class="auth-card">
        <div class="hero-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24">
            <path d="M20 4C11 4 4 10.3 4 18c0 .9.1 1.8.4 2.6A9.8 9.8 0 0 0 12 24c6.6 0 12-5.4 12-12V4h-4Z" />
            <path
              class="hero-vein"
        ...
        <p class="subtitle">{{ isLogin() ? 'A calm space for your tasks' : 'Set up your workspace in under a minute' }}</p>
...
export class LoginComponent {
    ...
    private validateForm(): string | null {
        return this.getFieldError('name') || this.getFieldError('email') || this.getFieldError('password');
    }
